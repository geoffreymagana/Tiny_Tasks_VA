...
import { CreateContractFormSchema, type CreateContractFormValues, type ContractStatus, type Contract } from '../schema';
...
interface ContractMetadataSidebarProps {
  form: ReturnType<typeof useForm<CreateContractFormValues & { tagsInput?: string }>>;
...
const ContractMetadataSidebar: FC<ContractMetadataSidebarProps> = ({
  ...
  return (
    <aside className="w-80 border-l border-border bg-background p-6 space-y-6 overflow-y-auto flex-shrink-0 transition-all duration-300">
      ...
      {!isTemplate && (
        <FormField control={form.control} name="status" render={({ field }) => ( // Changed field name here to avoid conflict with outer scope `field`
      ...
      <div className="min-h-screen bg-secondary/30 flex flex-col">
        ...
        <Dialog open={aiDialogGenerateOpen} onOpenChange={setAiDialogGenerateOpen}>
            ...
            <DialogHeader>
                ...
                <DialogDescription>Provide key details for the AI to draft the contract sections.</DialogDescription>
            </DialogHeader>
